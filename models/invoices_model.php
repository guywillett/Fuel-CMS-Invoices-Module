...
class Invoices_model extends Base_module_model {
	...
	function form_fields($values=array()){
		...
		$today = date("Y-m-d");
		$one_week = date("Y-m-d", strtotime($today." + 7 days"));
		$status_options = array('status1','status2','status 3');
		
		$fields['date']['order'] = "5";
		$fields['date']['default'] = $today;
		$fields['name']['order'] = "10";
		$fields['name']['label'] = 'Reference';
		$fields['copy5'] = array('type' => 'copy', 'tag' => 'p', 'value' => ' ', 'order' => 26);
		$fields['user_id']['order'] = '22';
		$fields['copy6'] = array('type' => 'copy', 'tag' => 'p', 'value' => ' ', 'order' => 24);
		$fields['due_date']['order'] = "25";
		$fields['paid']['order'] = '27';
		$fields['copy29'] = array('type' => 'copy', 'tag' => 'p', 'value' => ' ', 'order' => 29);
		$fields['content']['order'] = "30";
		$fields['copy4'] = array('type' => 'copy', 'tag' => 'p', 'value' => ' ', 'order' => 32);
		$fields['amount']['order'] = '33';
		$fields['tax']['order'] = '34';
		$fields['tax_total']['order'] = '35';
		$fields['total']['order'] = '36';
		$fields['copy38'] = array('type' => 'copy', 'tag' => 'p', 'value' => ' ', 'order' => 38);
		$fields['copy39'] = array('type' => 'copy', 'tag' => 'p', 'value' => ' ', 'order' => 39);
